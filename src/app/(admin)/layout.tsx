"use client";
// src/app/(admin)/layout.tsx — Chemistry Academy Edition
  ...
  return (
    <div className="min-h-screen" style={{ background: "#F0F4FF", direction: "rtl" }}>
      ...
      <main className="min-h-screen">
        <div className="lg:mr-64 px-3 sm:px-4 md:px-6 py-4 sm:py-5 md:py-7">
          {/* Mobile top bar */}
          <div className="flex lg:hidden items-center justify-between mb-5">
            ...
            <span style={{ fontFamily: "Cairo,sans-serif", color: "#0099CC", fontSize: 15, fontWeight: 700 }}>
