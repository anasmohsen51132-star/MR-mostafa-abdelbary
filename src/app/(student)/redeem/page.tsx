    ...
    <div style={{ direction: "rtl" }}>
      ...
      >
        ...
        <div className="text-center mb-10">
          ...
          <h1 style={{ fontFamily: "Cairo,sans-serif", color: "#0A0F1E", fontSize: 32, marginBottom: 8 }}>
            استخدام كود الوصول
          </h1>
          <p style={{ fontFamily: "Cairo,sans-serif", color: "#52607A", fontSize: 15, lineHeight: 1.7 }}>
        ...
        <AnimatePresence mode="wait">
          {!result ? (
            <motion.div
              ...
              style={{ background: "#fff", border: "1px solid rgba(0,212,255,0.2)", boxShadow: "0 8px 32px rgba(10,15,30,0.08)" }}
            >
              <form onSubmit={handleSubmit}>
                <div style={{ marginBottom: 24 }}>
                  <label
                    htmlFor="code"
                    style={{ fontFamily: "Cairo,sans-serif", color: "#52607A", fontSize: 13, marginBottom: 8, display: "block", fontWeight: 600 }}
                  >
                    كود الوصول
                  </label>
                  <input
                  ...
                  />
                  <p style={{ fontFamily: "Cairo,sans-serif", color: "#52607A", fontSize: 12, marginTop: 6, textAlign: "center" }}>
                ...
                <motion.button
                  ...
                  style={{
                    ...
                    boxShadow: !mutation.isPending && code.trim() ? "0 6px 20px rgba(0,212,255,0.4)" : "none",
              ...
              >
                <p style={{ fontFamily: "Cairo,sans-serif", color: "#52607A", fontSize: 13, lineHeight: 1.75 }}>
            ...
            <motion.div
              ...
              style={{ background: "#fff", border: "1px solid rgba(0,255,136,0.3)", boxShadow: "0 8px 32px rgba(10,15,30,0.08)" }}
            >
              ...
              <h2 style={{ fontFamily: "Cairo,sans-serif", color: "#111E38", fontSize: 32, marginBottom: 8 }}>
                تم التفعيل بنجاح!
              </h2>
              ...
              <div className="space-y-3 mb-8 text-right">
                {result.courses.map((c) => (
                  ...
                  >
                    ...
                    <div>
                      <p style={{ fontFamily: "Cairo,sans-serif", color: "#0A0F1E", fontSize: 14, fontWeight: 700 }}>
                        {c.title}
                      </p>
                      <p style={{ fontFamily: "Cairo,sans-serif", color: "#00FF88", fontSize: 12 }}>
                        ✅ تم الفتح
                      </p>
                    </div>
                  </motion.div>
