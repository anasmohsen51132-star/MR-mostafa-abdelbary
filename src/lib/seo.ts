...
export const SITE_NAME = "أكاديمية مستر مصطفى عبد الباري لتدريس الكيمياء";
export const SITE_NAME_SHORT = "أكاديمية مستر مصطفى";

export const SITE_DESCRIPTION =
  "منصة تعليم الكيمياء للثانوية العامة مع مستر مصطفى عبد الباري — شرح مبسط للكيمياء العضوية والتحليلية، معادلات موزونة، اختبارات تفاعلية، ومتابعة تقدم الطلاب.";

// Core keyword set — Chemistry Academy
export const SITE_KEYWORDS = [
  "أكاديمية مستر مصطفى عبد الباري",
  "تعليم الكيمياء",
